...
public class Compactador_Metal implements Dispositivo, Runnable{
	...
	Compactador_Metal(int qtdParaBloco){
	...
	@Override
	public void run() {
		System.out.println("Dispositivo Compactador de Metal LIGADO...");
		Material mat;
		...
		System.out.println("Dispositivo Compactador de Metal DESLIGADO");
		exibirLog();
	}
	...
	public void compacta() {
		...
		Bloco bloco = new Bloco("metal", qtdParaBloco);
		entrada_armazem.set(bloco);
		System.out.println("Bloco compactado: metal...");
		qtdBlocos++;
